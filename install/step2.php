...
<body style='background-color: #FBFBFB;'>
    <div id='main-container'>
        ...
        <div class="span12">
            <h4> wifims Installer </h4>
            <?php
            $passed = '';
            $ltext = '';
            if (version_compare(PHP_VERSION, '7.2.0') >= 0) {
                $ltext .= 'To Run wifims  You need at least PHP version 7.2.0, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---PASSED---</strong><br/>";
                $passed .= '1';
            } else {
                $ltext .= 'To Run wifims  You need at least PHP version 7.2.0, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---FAILED---</strong><br/>";
                $passed .= '0';
            }
            ...
            if ($passed == '111') {
                echo ("<br/> $ltext <br/> Great! System Test Completed. You can run wifims on your server. Click Continue For Next Step.
				<br><br>
                <a href=\"update.php\" class=\"btn btn-warning\">Update System From wifims</a>
                <br><br><br><br>
    ...
    <div class="footer">Copyright &copy; 2024 wifims. All Rights Reserved<br /><br /></div>
</body>
