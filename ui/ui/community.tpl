...
<center><a href="https://speedcomwifi.xyz" target="_blank"><img src="https://raw.githubusercontent.com/sabtech254/wifims/refs/heads/main/install/img/logo.png" class="img-responsive"></a></center>
<br><br>
...
<div class="row">
    ...
    <div class="col-sm-6" id="update">
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-body">
                <b>wifims</b> is a billing Hotspot ,Static IP and PPPOE for Mikrotik using PHP and Mikrotik API to comunicate with router. If you get more profit with this application, please donate us.<br>Watch project <a href="https://chat.whatsapp.com/HjnLYIEN6h0A0KMXbfNYP5" target="_blank">in here</a>
            </div>
